...
![image.png](/img/yuque/计算机/深度学习/命名实体识别/assets/翻译_综述_A_Survey_on_Deep_Learning_for_Named-1.png)
...
![image.png](/img/yuque/计算机/深度学习/命名实体识别/assets/翻译_综述_A_Survey_on_Deep_Learning_for_Named-2.png)
...
![image.png](/img/yuque/计算机/深度学习/命名实体识别/assets/翻译_综述_A_Survey_on_Deep_Learning_for_Named-3.png)
...
需要注意的是, 上面这个例子还没考虑实体边界的情况, 具体可以看这个代码 [https://github.com/Pelhans/Entity\_Linking/blob/master/evaluation.py](https://github.com/Pelhans/Entity_Linking/blob/master/evaluation.py) (作者找不到了= =).
...
![image.png](/img/yuque/计算机/深度学习/命名实体识别/assets/翻译_综述_A_Survey_on_Deep_Learning_for_Named-4.png)
...
![image.png](/img/yuque/计算机/深度学习/命名实体识别/assets/翻译_综述_A_Survey_on_Deep_Learning_for_Named-5.png)
...
![image.png](/img/yuque/计算机/深度学习/命名实体识别/assets/翻译_综述_A_Survey_on_Deep_Learning_for_Named-6.png)
...
![image.png](/img/yuque/计算机/深度学习/命名实体识别/assets/翻译_综述_A_Survey_on_Deep_Learning_for_Named-7.png)
...
![image.png](/img/yuque/计算机/深度学习/命名实体识别/assets/翻译_综述_A_Survey_on_Deep_Learning_for_Named-8.png)
...
![image.png](/img/yuque/计算机/深度学习/命名实体识别/assets/翻译_综述_A_Survey_on_Deep_Learning_for_Named-9.png)
...
![image.png](/img/yuque/计算机/深度学习/命名实体识别/assets/翻译_综述_A_Survey_on_Deep_Learning_for_Named-10.png)
...
![image.png](/img/yuque/计算机/深度学习/命名实体识别/assets/翻译_综述_A_Survey_on_Deep_Learning_for_Named-11.png)
...
![image.png](/img/yuque/计算机/深度学习/命名实体识别/assets/翻译_综述_A_Survey_on_Deep_Learning_for_Named-12.png)
...
![image.png](/img/yuque/计算机/深度学习/命名实体识别/assets/翻译_综述_A_Survey_on_Deep_Learning_for_Named-13.png)
...
![image.png](/img/yuque/计算机/深度学习/命名实体识别/assets/翻译_综述_A_Survey_on_Deep_Learning_for_Named-14.png)
...
论文(Neural models for sequence chunking) 首先应用指针网络来产生序列标签。 如上图 （d）所示，指针网络首先识别块（或段），然后对其进行标记。 重复该操作，直到处理了输入序列中的所有单词。 在上图 d 中，给定起始标记“ ”，首先标识段“ Michael Jeffery Jordan”，然后将其标记为“ PERSON”。 分割和标记可以通过指针网络中的两个独立的神经网络来完成。 接下来，将“ Michael Jeffery Jordan”作为输入并输入到指针网络中。 结果，“was”被识别并标记为“ O”。

## 基于 DL 的NER 总结

下图给出了近期在 NER 方面的工作汇总

![image.png](/img/yuque/计算机/深度学习/命名实体识别/assets/翻译_综述_A_Survey_on_Deep_Learning_for_Named-15.png)
