...
![](/img/yuque/计算机/深度学习/深度学习基础/assets/5._常见损失函数-1.png)
...
![](/img/yuque/计算机/深度学习/深度学习基础/assets/5._常见损失函数-2.png)
...
2.  [Tensorflow中的损失函数](https://zhuanlan.zhihu.com/p/45200767)
3.  [【AI初识境】深度学习中常用的损失函数有哪些（覆盖分类，回归，风格化，GAN等任务）？](https://zhuanlan.zhihu.com/p/60302475)
4.  [【技术综述】一文道尽softmax loss及其变种](https://zhuanlan.zhihu.com/p/34044634)
5.  [损失函数改进之Large-Margin Softmax Loss](https://blog.csdn.net/u014380165/article/details/76864572)
{% endraw %}
