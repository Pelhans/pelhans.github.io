...
![](/img/yuque/计算机/深度学习/深度学习基础/assets/2._拉格朗日乘数法与KKT条件-1.jpeg)
...
已知函数 $f(x, y, z) = 8xyz$，约束条件为 $\frac{x_{2}}{a_{2}} + \frac{y_{2}}{b_{2}} + \frac{z_{2}}{c_{2}} = 1$，求函数 $f(x)$的最大值。
...
![](/img/yuque/计算机/深度学习/深度学习基础/assets/2._拉格朗日乘数法与KKT条件-2.png)
