...
![](/img/yuque/计算机/知识图谱/知识图谱入门笔记系列/assets/5._知识存储-1.png)
...
endpoint的SPARQL 查询网址为: [http://localhost:3030/music/query;](http://localhost:3030/music/query;)  
更新网址为：[http://localhost:3030/music/update](http://localhost:3030/music/update) .
...
在更新时要更换端口地址为: [http://localhost:3030/music/update](http://localhost:3030/music/update)
...
![](/img/yuque/计算机/知识图谱/知识图谱入门笔记系列/assets/5._知识存储-2.png)
...
![](/img/yuque/计算机/知识图谱/知识图谱入门笔记系列/assets/5._知识存储-3.png)
