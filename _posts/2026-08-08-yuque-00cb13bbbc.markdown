...
![](/img/yuque/计算机/深度学习/assets/对比学习笔记-1.png)
...
![](/img/yuque/计算机/深度学习/assets/对比学习笔记-2.png)
...
$$
l_{align} = E_{x, x^{+} \sim p_{pos}} ||f(x) - f(x^{+}) ||^{2}
$$

Uniformity 用于衡量系统保留信息的多样性，评价指标是映射到单位球面的特征，尽可能的均匀分布在球面上，分布的越均匀，意味着保留的信息越充分。

$$
l_{uniform} = log E_{x,y \sim p_{data}} e^{-2||f(x) - f(y) ||^{2}}
$$
...
-   NCE 到 infoNCE 的推导：[https://zhuanlan.zhihu.com/p/334772391](https://zhuanlan.zhihu.com/p/334772391)
