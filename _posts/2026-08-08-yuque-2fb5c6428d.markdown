...
1.  SGD: tf.train.GradientDescentOptimizer()
2.  Adam: tf.train.AdamOptimizer()
3.  Adagrad: tf.train.AdagradOptimizer()
4.  Adadetla: tf.train.AdadeltaOptimizer()
5.  RMSProp: tf.train.RMSPropOptimizer()
6.  FTRL: tf.train.FtrlOptimizer()
7.  Momentum: tf.train.MomentumOptimizer(lr, momentum)
8.  Nesterov Acceletate Gradient: tf.train.MomentumOptimizer(lr, momentum, use\_nesterov)
...
![](/img/in-post/tensorflow/ml_opti.jpg)![](/img/yuque/计算机/深度学习/深度学习基础/assets/1._深度学习中的常见优化算法-1.jpeg)
{% endraw %}
